...
export function Sidebar({ children, className, ...props }: SidebarProps) {
  ...
  if (isMobile) {
    return (
      <>
        ...
        <aside
          className={cn(
            "fixed inset-y-0 left-0 z-50 w-[280px] bg-[#121214] border-r border-white/10 transform transition-transform duration-300 ease-out",
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "hidden md:flex flex-col fixed inset-y-0 left-0 z-40 border-r border-white/10 bg-[#121214] transition-all duration-200",
          open
            ? "w-[var(--sidebar-width)]"
