...
General technical specifications, design systems, and project references.
...
See `../epics/` for technical specifications specific to individual epics.

## Integrations

See `../integrations/` for integration specifications and guides.
