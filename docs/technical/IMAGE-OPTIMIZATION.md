...
**Location:** `scripts/compress-slider-images.py`
...
If you need to adjust settings, edit `scripts/compress-slider-images.py`:
...
- Check that `scripts/compress-slider-images.py` exists
