...
- `app/studio/hooks/useStudioHandlers.ts` - **375 lines** 🔴 (Needs review)
- `app/influencer/[id]/page.tsx` - **369 lines** 🔴 (Needs review)
- `app/settings/components/delete-account-dialog.tsx` - **297 lines** 🟡 (Consider extracting)
- `app/api/finby/webhook/route.ts` - **297 lines** 🟡 (API route - acceptable)
- `app/buy-credits/page.tsx` - **289 lines** 🟡 (Needs review)
