...
| influencer/[id]/page.tsx | 369 | ~150 | 🔄 Pending | Extract hooks & components |
| buy-credits/page.tsx | 289 | ~150 | 🔄 Pending | Extract modal & hooks |
| delete-account-dialog.tsx | 297 | ~150 | 🔄 Pending | Extract step components |
