...
export function HeroSection() {
  return (
    <section className="relative min-h-[85vh] flex flex-col justify-center pt-20 pb-20 overflow-hidden bg-[var(--bg-primary)]">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <FadeInUp delay={0}>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[var(--text-primary)] leading-tight mb-4">
              Create <span className="text-gradient">AI influencers</span> that earn 24/7.
            </h1>
          </FadeInUp>
          ...
          <FadeInUp delay={100}>
            <p className="text-base md:text-lg text-[var(--text-secondary)] max-w-xl mx-auto mb-6">
              Hyper-realistic. Consistent. Ready to monetize on Fanvue, OnlyFans, TikTok & more.
            </p>
          </FadeInUp>
          ...
          {/* Platform logos */}
          <FadeInUp delay={300}>
            <LogoMarquee speed="slow" fadeEdges className="max-w-md mx-auto">
              <PlatformLogo name="tiktok" size="sm" />
              <PlatformLogo name="instagram" size="sm" />
              <PlatformLogo name="fanvue" size="sm" />
              <PlatformLogo name="onlyfans" size="sm" />
            </LogoMarquee>
          </FadeInUp>
        </div>
      </Container>
