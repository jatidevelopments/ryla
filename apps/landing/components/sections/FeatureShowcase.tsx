...
const notifications = [
  { icon: '💰', title: 'New subscriber', time: '2m ago', platform: 'TikTok' },
  { icon: '❤️', title: 'Post liked', time: '5m ago', platform: 'Instagram' },
  {
    icon: '📈',
...
const features = [
  ...
  },
  {
    ...
    description:
      'Change outfits and styles with one click instead of long prompts.',
    href: '#',
    cta: 'Learn more',
    className: 'col-span-3 lg:col-span-1 lg:row-span-2',
    background: (
  ...
  },
  {
    ...
    description:
      'Dance, selfie, driving, custom—create viral content in one click.',
    href: '#',
    cta: 'Learn more',
    className: 'col-span-3 lg:col-span-1',
    background: (
    ...
    background: (
      <div className="absolute inset-0">
        <div className="absolute top-4 right-4 px-2 py-1 rounded-full bg-amber-500/20 border border-amber-500/40 backdrop-blur-sm">
          <span className="text-[10px] text-amber-300 font-medium italic uppercase tracking-wider">
            Coming Soon
          </span>
        </div>
  ...
  },
  {
    ...
    iconColor: iconColors.green, // Monetization/Platform
    name: 'Multi-Platform',
    description: 'Post to TikTok, Instagram, and more.',
    href: '#',
    cta: 'Learn more',
    className: 'col-span-3 lg:col-span-1',
    background: (
      ...
      <div className="absolute inset-0 [mask-image:linear-gradient(to_top,transparent_25%,#000_100%)]">
        ...
        <div className="absolute top-4 left-4 right-4 flex flex-col items-center gap-3">
          ...
          <div className="flex gap-2">
            <span className="px-2 py-1 rounded-full bg-purple-500/30 border border-purple-500/40 text-[10px] text-purple-300 backdrop-blur-sm">
              Niche Finding
            </span>
            <span className="px-2 py-1 rounded-full bg-pink-500/30 border border-pink-500/40 text-[10px] text-pink-300 backdrop-blur-sm">
              Monetization
            </span>
          </div>
        </div>
