...
export const metadata: Metadata = {
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Ryla.ai AI Influencer Creation Platform",
            },
        ],
    },
    twitter: {
    ...
    icons: {
        icon: [
            { url: withCdn("/favicon/favicon-16x16.png"), sizes: "16x16", type: "image/png" },
            { url: withCdn("/favicon/favicon-32x32.png"), sizes: "32x32", type: "image/png" },
        ],
    ...
    return (
        <html suppressHydrationWarning>
            <head>
                ...
                {/* Favicon Links */}
                <link rel="icon" type="image/x-icon" href={withCdn("/favicon/favicon.ico")} />
                <link
                    rel="icon"
                    type="image/png"
                    sizes="16x16"
                ...
                />
                <link rel="apple-touch-icon" href={withCdn("/favicon/apple-touch-icon.png")} />
            ...
            <body suppressHydrationWarning className={`${jakartaSans.className} antialiased`}>
                <Providers>
