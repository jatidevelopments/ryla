...
const signUpSchema = z.object({
    ...
    isAdult: z.literal(true, {
        errorMap: () => ({ message: "You must confirm that you are 18 years or older." }),
    }),
...
export function useSignUpForm(posthog?: any) {
    ...
    const onSubmit = form.handleSubmit((values) => {
        ...
        const customBreast = (funnelFormValues.influencer_breast_type || "medium") + "-" + (funnelFormValues.influencer_breast_type || "natural");
                ...
                dtoAdultFannelV3: {
                    character_options: {
                        ...
                        character: {
                            ...
                            voice: (funnelFormValues.influencer_voice && voicesMap[funnelFormValues.influencer_voice as keyof typeof voicesMap]) || voicesMap["seducing"],
                            breast: customBreast,
