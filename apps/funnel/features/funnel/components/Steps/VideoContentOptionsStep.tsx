                        ...
                        <div className="bg-gradient-to-br from-white/8 to-white/4 border border-white/10 rounded-2xl p-5 shadow-lg backdrop-blur-sm">
                            <div className="grid grid-cols-2 gap-3">
                                {videoContentOptions.map((option) => {
                                    const optionData = VIDEO_CONTENT_OPTIONS.find(
                                        ...
                                        >
                                            ...
                                            <div className="absolute inset-0 flex flex-col justify-end p-4 z-10">
                                                ...
                                                <div className="flex items-center gap-2.5">
                                                    {/* Icon */}
                                                    <div
                                                        className={`w-9 h-9 rounded-lg ${option.gradient} flex items-center justify-center shadow-lg transition-all duration-200 flex-shrink-0 backdrop-blur-sm border border-white/20 ${
                ...
                <div className="w-full flex items-center justify-center px-[15px] sm:px-0 p-5 bg-black-2 sm:static fixed bottom-0 left-0 z-100">
                    <div className="max-w-[450px] w-full">
                        ...
                        >
                            ...
                            <span className="text-base font-bold relative z-10">Let's Create Viral Videos</span>
                        </Button>
