"""
RYLA Wan2 Modal App - Isolated App for Wan2.1 Workflows

Deploy: modal deploy apps/modal/apps/wan2/app.py

This app handles:
- /wan2 - Wan2.1 text-to-video generation

Agent Assignment: Wan2 Agent (isolated files)
"""
...
_app_dir = Path(__file__).parent  # apps/modal/apps/wan2/
...
# Import Wan2-specific image (extends base)
from image import wan2_image

# Import handlers
from handlers.wan2 import setup_wan2_endpoints

# Create Modal app
app = modal.App(name="ryla-wan2", image=wan2_image)
...
class ComfyUI:
    """ComfyUI server class for Wan2 workflows."""
    ...
    def launch_comfy_background(self):
        ...
        print("✅ ComfyUI server started for Wan2 app")
    ...
    def fastapi_app(self):
        """FastAPI endpoint for Wan2 workflows."""
        ...
        fastapi = FastAPI(
            title="RYLA Wan2 API",
            description="Wan2.1 text-to-video generation",
        )
        ...
        @fastapi.get("/health")
        async def health():
            return {"status": "healthy", "app": "ryla-wan2"}
