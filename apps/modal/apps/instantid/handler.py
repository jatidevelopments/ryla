...
Handles SDXL + InstantID face consistency generation.

Available endpoints:
- /sdxl-instantid - SDXL + InstantID (recommended for face consistency)

Note: Flux InstantID and Flux IP-Adapter FaceID were removed due to architectural 
incompatibilities. SDXL InstantID is the working solution for face consistency.
"""
...
from image_utils import save_base64_to_file
