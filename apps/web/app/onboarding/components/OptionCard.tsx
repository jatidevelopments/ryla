...
export function OptionCard({ option, selected, onClick, showDescription }: OptionCardProps) {
  return (
    <button
      onClick={onClick}
      className={cn(
    ...
    >
      ...
      <div className="relative z-10 flex items-center gap-3">
        ...
        <div className={cn('flex-1', showDescription ? '' : 'min-w-0')}>
          <h3 className={cn('text-sm font-bold text-white', !showDescription && 'truncate')}>
            {option.label}
          </h3>
