            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="space-y-8 text-white/70 leading-relaxed text-[15px]">
                ...
                <section>
                  ...
                  <p>
                    We employ proprietary "Child Protection" safety filters on
                    our AI models. These filters are specifically designed to
                    prevent the generation of content that resembles or exploits
                    the likeness of minors. Any attempt to bypass these filters
                    will be logged and reported to relevant authorities (e.g.,
                    NCMEC).
                  </p>
                </section>
              </div>
              ...
              <div className="space-y-8 text-white/70 leading-relaxed text-[15px]">
                ...
                <section>
                  ...
                  <p>
                    ...
                    attempts to sabotage another user's AI persona will not be
                    tolerated.
                  </p>
                </section>
