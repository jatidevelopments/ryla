...
export async function POST(_request: NextRequest) {
  console.warn(
    '[DEPRECATED] /api/finby/setup-payment is deprecated. Use backend API /payments/session instead.'
  );

  return NextResponse.json(
    {
      error:
        'This endpoint is deprecated. Please use the backend API at /payments/session',
      code: 'DEPRECATED_ENDPOINT',
      message:
        'This Next.js API route has been deprecated. Payment processing should be done through the backend API.',
      backendEndpoint: `${
