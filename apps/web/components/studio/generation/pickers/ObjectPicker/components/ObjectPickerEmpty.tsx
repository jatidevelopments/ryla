...
interface ObjectPickerEmptyProps {
  hasSearch: boolean;
}

export function ObjectPickerEmpty({ hasSearch }: ObjectPickerEmptyProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p className="text-white/50 max-w-sm">{hasSearch ? 'Try a different search term' : 'No images available to use as objects'}</p>
    </div>
  );
}
