      ...
      <div className="hidden sm:flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-white/50">
            Select up to {maxObjects} objects to add to your image
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-end gap-2 sm:gap-3">
        ...
        {hasUpload && (
          <button
            ...
            className="flex items-center gap-2 p-2.5 sm:px-4 sm:py-2 rounded-xl text-sm font-medium transition-all bg-[var(--purple-500)]/20 text-[var(--purple-400)] hover:bg-[var(--purple-500)]/30 border border-[var(--purple-500)]/30 disabled:bg-white/5 disabled:text-white/40 disabled:cursor-not-allowed"
          >
            {isUploading ? (
              <>
                <svg
