...
export function StylePickerTabs({
  activeTab,
  onTabChange,
}: StylePickerTabsProps) {
  return (
    <nav className="flex items-center gap-1 sm:gap-2 overflow-x-auto scroll-hidden -mx-2 sm:mx-0 px-2 sm:px-0">
      {tabs.map((tab) => (
        <button
          key={tab.id}
          onClick={() => {
