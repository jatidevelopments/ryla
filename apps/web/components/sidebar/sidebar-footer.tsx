...
export function SidebarFooter({
  ...
  return (
    <>
      ...
      {isExpanded && <CreditsBadge size="md" className="mt-3" />}
      ...
      <Link
        ...
        className={cn(
          ...
          isSettingsActive ? 'bg-white/10 shadow-sm' : 'hover:bg-white/5',
          !isExpanded && 'justify-center px-0'
        )}
      >
        {/* Avatar */}
        ...
        {isExpanded && <ChevronRightIcon className="text-white/30 shrink-0" />}
      </Link>

      {/* Divider before legal links */}
      {isExpanded && <div className="mt-4 border-t border-white/5" />}
