      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-[#121214]/90 backdrop-blur-md border-t border-white/5 md:relative md:p-0 md:bg-transparent md:border-none md:mt-0 z-30">
        <div className="max-w-2xl mx-auto">
          <button
            ...
            disabled={disabled}
            className={cn(
              'w-full h-12 md:h-14 rounded-xl font-bold text-base md:text-lg shadow-lg transition-all relative overflow-hidden group',
              hasEnoughCredits && hasSelectedBaseImage
                ? 'bg-gradient-to-r from-purple-500 to-violet-600 text-white shadow-purple-500/30 hover:shadow-purple-500/50'
