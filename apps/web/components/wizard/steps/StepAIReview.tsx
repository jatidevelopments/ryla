  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <button
        ...
        className="w-full h-12 rounded-xl font-bold text-base bg-gradient-to-r from-[#c4b5fd] to-[#7c3aed] text-white shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 transition-all relative overflow-hidden group"
      >
