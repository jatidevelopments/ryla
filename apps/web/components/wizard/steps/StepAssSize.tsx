...
import { INFLUENCER_ASS_SIZES } from '../../../constants';
import { getAssSizeImage } from '../../../lib/utils/get-influencer-image';

/**
 * Step: Ass Size Selection
 */
export function StepAssSize() {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-white text-2xl font-bold">Ass Size</h1>
      </div>
