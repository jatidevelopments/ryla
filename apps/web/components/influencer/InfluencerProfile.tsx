...
export function InfluencerProfile({
  ...
  return (
    <div className="px-3 pt-3 pb-8">
      ...
      {/* Profile container with rounded glassmorphism style */}
      <div className="relative rounded-2xl border border-white/[0.08] bg-[#121214]/70 backdrop-blur-2xl backdrop-saturate-150 shadow-[0_4px_16px_-2px_rgba(0,0,0,0.2)] overflow-hidden">
        {/* Subtle background gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--purple-500)]/5 via-transparent to-[var(--pink-500)]/5" />

        {/* Profile header */}
        <div className="relative flex flex-col px-6 py-8 sm:flex-row sm:items-start sm:justify-between sm:gap-8">
