...
```bash
python scripts/extract-comfyui-models.py --url https://your-server.com
```

### Custom Output Directory

```bash
python scripts/extract-comfyui-models.py --output-dir ./my-output
```

### Slow Mode (For Debugging)

```bash
python scripts/extract-comfyui-models.py --slow-mo 500
```
...
- [Model Downloader Script](./download-comfyui-models.py)
