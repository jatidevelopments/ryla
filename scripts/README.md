...
2. **Run the Script**:
   ...
   ```bash
   pnpm tsx scripts/extract-comfyui-models-playwright.ts
   ```
...
3. **With Options**:
   ...
   pnpm tsx scripts/extract-comfyui-models-playwright.ts --no-headless

   # Specify custom URL
   pnpm tsx scripts/extract-comfyui-models-playwright.ts --url https://your-comfyui-server.com

   # Custom output directory
   pnpm tsx scripts/extract-comfyui-models-playwright.ts --output-dir ./output
   ```
...
2. **Run the Script**:
   ...
   ```bash
   python scripts/extract-comfyui-models.py
   ```
...
3. **With Options**:
   ...
   python scripts/extract-comfyui-models.py --headless

   # Specify custom URL
   python scripts/extract-comfyui-models.py --url https://your-comfyui-server.com

   # Custom output directory
   python scripts/extract-comfyui-models.py --output-dir ./output
   ```
